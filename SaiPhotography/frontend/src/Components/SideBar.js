    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/InventoryManagement">
                    <ListItemIcon>
                        <SupervisorAccountOutlinedIcon color={location.pathname.startsWith("/InventoryManagement") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
