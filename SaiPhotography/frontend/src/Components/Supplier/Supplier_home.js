...
function Home() {
    ...
    return (
        <div style={{ backgroundImage: 'url("Images/back2.jpg")', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', minHeight: '100vh' }}>
            <Navbar />
            <div className="container" style={{ backgroundColor: "#E5E5E5", padding: '20px', borderRadius: '10px', marginTop: '20px' }}>
                ...
                <h2 className="text-center mb-4"><b>SUPPLIERS DETAILS</b></h2>
                <table className="table table-striped table-bordered">
                    <thead>
                        <tr style={{ backgroundColor: '#002f62', color: 'white' }}>
                            ...
                            <th scope="col">QUANTITY CHECK</th>
                        </tr>
                    </thead>
                    <tbody>
